        ...
        <div className="p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <span className={`px-2 py-1 text-lg font-semibold leading-tight rounded-full ${
                transaction.status === 'success' ? 'bg-green-200 text-green-800' : 'bg-yellow-200 text-yellow-800'
              }`}>
                {transaction.status}
              </span>
            </div>
            ...
            <div>
              ...
              <p>{new Date(transaction.payment_time).toLocaleString()}</p>
            </div>
            <div>
              <p className="font-bold">Bank Reference:</p>
              <p>{transaction.bank_reference}</p>
            </div>
          </div>
        </div>
      )}
